...
const Bar = ({ value }) => {
    ...
    const [animatedHeight, setAnimatedHeight] = require$$0.useState(0);
    const [animatedY, setAnimatedY] = require$$0.useState(chartHeight);
    const animationRef = require$$0.useRef(0);
    require$$0.useEffect(() => {
